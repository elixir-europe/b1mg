    ...
    <div class="container content has-text-grey-darker">
        ...
        <div class="accordion-panel">
          <div>
             ...
             <p> Here, we will establish a <a href="https://zenodo.org/record/4889391#.YLYFWzZKhQY">set of metrics</a>, either for raw and processed sequencing data, that assures final data reaches an acceptable quality threshold for clinical purposes. Exceeding these thresholds would constitute Good Genomic Practice.</p>
        ...
        <tbody>
          <tr>
            <td>D3.1</td>
            <td><strong><a href="https://zenodo.org/record/4889391#.YLYFWzZKhQY">Quality metrics for sequencing</a></strong><br />
          ...
          <tr>
            <td>D3.7</td>
            <td><strong><a href="https://zenodo.org/record/4819149#.YK_bKZNKj0o">Documented best practices in sharing and linking phenotypic and genetic data</a></strong><br />Publication of an iterative document on available best practices in sharing and linking phenotypic and genetic data.</td>
            <td>May 2021</td>
          </tr>
          <tr>
            <td>D3.8</td>
        ...
        <div class="columns profiles percent-50">
          ...
          <div class="column">
            <figure>
              ...
              <figcaption>Jeroen Beliën (Amsterdam UMC, Vrije Universiteit Amsterdam)</figcaption>
            </figure>
          </div>
